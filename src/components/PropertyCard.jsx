    ...
    return (
        <div className="card bg-white border border-gray-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
            <figure className="relative h-56">
                ...
                ${data.price}<span className="text-xs font-normal opacity-80">/mo</span>
                </div>
            </figure>
            ...
            <div className="card-body p-5">
                ...
                <Link to="/homeads/1" className="btn btn-ghost btn-sm text-orange-600 font-bold hover:bg-orange-50">Details</Link>
